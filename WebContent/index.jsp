    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="text-right">
                <a href="protected/mon_compte.jsp">Mon compte</a>
            </div>
            ...
            <h4 class="my-1">Vous n'avez pas trouvé le vôtre ?</h4>
            <div class="my-2 alert alert-primary">Cliquez ci-dessous pour en rechercher un autre...</div>
            <div class="text-center my-3">
                <a href="search.html" class="img" title="Rechercher un entrainement">
                    <img width="150px" src="resources/images/search.png" />
                </a>
