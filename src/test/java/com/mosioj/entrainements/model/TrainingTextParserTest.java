...
public class TrainingTextParserTest {
	...
	@Test
	public void test_16_12_2014() throws IOException {
		TrainingTextParser parser = readTraining("mardi_16_12_2014.txt");
		assertEquals(4000, parser.getTrainingSize());
	}

	@Test
	public void test_23_09_2019() throws IOException {
		TrainingTextParser parser = readTraining("lundi_23_09_2019.txt");
		assertEquals(4300, parser.getTrainingSize()); // FAUX !! Devrait être 4000 mais trop compliqué pour le moment...
	}
}
